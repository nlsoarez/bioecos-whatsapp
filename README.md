...
docker build --pull=false --build-arg BUILD_REVISION=COMMIT_REVISADO -t bioecos-whatsapp:0.2.1-security .
docker build --pull=false -f Dockerfile.backup -t bioecos-backup:0.2.1-security .
```
